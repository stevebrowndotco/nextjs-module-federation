...
/******/ 	!function() {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "nextjs-ssr_home:";
...
/******/ 			var uniqueName = "nextjs-ssr_home";
...
/******/ 			switch(name) {
/******/ 				case "default": {
/******/ 					register("next/dynamic", "12.2.2", function() { return __webpack_require__.e(617).then(function() { return function() { return __webpack_require__(5218); }; }); });
/******/ 					register("next/link", "12.2.2", function() { return Promise.all([__webpack_require__.e(162), __webpack_require__.e(894)]).then(function() { return function() { return __webpack_require__(9894); }; }); });
/******/ 					register("next/script", "12.2.2", function() { return Promise.all([__webpack_require__.e(162), __webpack_require__.e(218)]).then(function() { return function() { return __webpack_require__(3218); }; }); });
/******/ 					initExternal(9968);
/******/ 					initExternal(8127);
/******/ 				}
/******/ 				break;
...
/******/ 				} else {
/******/ 					if(!/^(426|658|88)$/.test(chunkId)) {
/******/ 						// load the chunk and return promise to it
/******/ 						var promise = new Promise(async function(resolve, reject) {
/******/ 							installedChunkData = installedChunks[chunkId] = [resolve, reject];
/******/ 							var filename = require('path').join(__dirname, "chunks/" + __webpack_require__.u(chunkId));
/******/ 							var fs = require('fs');
...
/******/ 		
/******/ 		
/******/ 								var remotes = {"home":"http://localhost:3001/_next/static/ssr/remoteEntry.js","shop":"http://localhost:3002/_next/static/ssr/remoteEntry.js","checkout":"http://localhost:3000/_next/static/ssr/remoteEntry.js"};
...
/******/ 		
/******/ 		
/******/ 								var requestedRemote = remoteRegistry["home"]
/******/ 		
